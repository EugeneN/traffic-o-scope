...
This is Traffic-o-scope, an application designed to give users back the power to control their [mostly HTTP-based] traffic, by providing insights, analysis, managing tools.
